...
static XfceGtkActionEntry action_entries[] =
{
    ...
    { TERMINAL_WINDOW_ACTION_SHORTCUTS,             "<Actions>/terminal-window/shortcuts",             "",                          XFCE_GTK_IMAGE_MENU_ITEM, N_ ("Short_cuts..."),                 N_ ("Open the shortcuts dialog"),         "",                       G_CALLBACK (terminal_window_action_shortcuts), },
