...
static XfceGtkActionEntry action_entries[] =
{
    ...
    { TERMINAL_WINDOW_ACTION_RESET_AND_CLEAR,       "<Actions>/terminal-window/reset-and-clear",       "<control><shift>k",                          XFCE_GTK_MENU_ITEM,       N_ ("_Clear Scrollback and Reset"),   NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_reset_and_clear), },
