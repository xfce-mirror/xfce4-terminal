...
static void         terminal_window_action_undo_close_tab         (TerminalWindow      *window);
static void         terminal_window_action_detach_tab             (TerminalWindow      *window);
static void         terminal_window_action_close_tab              (TerminalWindow      *window);
static void         terminal_window_action_close_other_tabs       (TerminalWindow      *window);
static void         terminal_window_action_close_window           (TerminalWindow      *window);
static void         terminal_window_action_copy                   (TerminalWindow      *window);
#if VTE_CHECK_VERSION (0, 49, 2)
static void         terminal_window_action_copy_html              (TerminalWindow      *window);
#endif
static void         terminal_window_action_paste                  (TerminalWindow      *window);
static void         terminal_window_action_paste_selection        (TerminalWindow      *window);
...
static void         terminal_window_action_show_toolbar           (TerminalWindow      *window);
static void         terminal_window_action_show_borders           (TerminalWindow      *window);
static void         terminal_window_action_fullscreen             (TerminalWindow      *window);
static void         terminal_window_action_readonly               (TerminalWindow      *window);
static void         terminal_window_action_scroll_on_output       (TerminalWindow      *window);
static void         terminal_window_action_zoom_in                (TerminalWindow      *window);
static void         terminal_window_action_zoom_out               (TerminalWindow      *window);
static void         terminal_window_action_zoom_reset             (TerminalWindow      *window);
static void         terminal_window_action_prev_tab               (TerminalWindow      *window);
static void         terminal_window_action_next_tab               (TerminalWindow      *window);
static void         terminal_window_action_last_active_tab        (TerminalWindow      *window);
static void         terminal_window_action_move_tab_left          (TerminalWindow      *window);
static void         terminal_window_action_move_tab_right         (TerminalWindow      *window);
static void         terminal_window_action_goto_tab               (GtkRadioAction      *action,
                                                                   GtkNotebook         *notebook);
static void         terminal_window_action_set_title              (TerminalWindow      *window);
static void         terminal_window_action_set_title_color        (TerminalWindow      *window);
static void         terminal_window_action_search                 (TerminalWindow      *window);
static void         terminal_window_action_search_next            (TerminalWindow      *window);
static void         terminal_window_action_search_prev            (TerminalWindow      *window);
...
{
    { TERMINAL_WINDOW_ACTION_FILE_MENU,         "<Actions>/TerminalWindow/file-menu",        NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("_File"),                         NULL,                                     NULL,                     NULL, },
    { TERMINAL_WINDOW_ACTION_NEW_TAB,           "<Actions>/TerminalWindow/new-tab",          "<control><shift>t",         XFCE_GTK_MENU_ITEM,       N_ ("Open _Tab"),                     N_ ("Open a new terminal tab"),           "tab-new",                G_CALLBACK (terminal_window_action_new_tab), },
    { TERMINAL_WINDOW_ACTION_NEW_WINDOW,        "<Actions>/TerminalWindow/new-window",       "<control><shift>n",         XFCE_GTK_MENU_ITEM,       N_ ("Open T_erminal"),                N_ ("Open a new terminal window"),        "window-new",             G_CALLBACK (terminal_window_action_new_window), },
    { TERMINAL_WINDOW_ACTION_UNDO_CLOSE_TAB,    "<Actions>/TerminalWindow/undo-close-tab",   "<control><shift>d",         XFCE_GTK_MENU_ITEM,       N_ ("_Undo Close Tab"),               NULL,                                     "document-revert",        G_CALLBACK (terminal_window_action_undo_close_tab), },
    { TERMINAL_WINDOW_ACTION_DETACH_TAB,        "<Actions>/TerminalWindow/detach-tab",       NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("_Detach Tab"),                   NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_detach_tab), },
    { TERMINAL_WINDOW_ACTION_CLOSE_TAB,         "<Actions>/TerminalWindow/close-tab",        "<control><shift>w",         XFCE_GTK_MENU_ITEM,       N_ ("Close T_ab"),                    NULL,                                     "window-close",           G_CALLBACK (terminal_window_action_close_tab), },
    { TERMINAL_WINDOW_ACTION_CLOSE_OTHER_TABS,  "<Actions>/TerminalWindow/close-other-tabs", NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("Close Other Ta_bs"),             NULL,                                     "edit-clear",             G_CALLBACK (terminal_window_action_close_other_tabs), },
    { TERMINAL_WINDOW_ACTION_CLOSE_WINDOW,      "<Actions>/TerminalWindow/close-window",     "<control><shift>q",         XFCE_GTK_MENU_ITEM,       N_ ("Close _Window"),                 NULL,                                     "application-exit",       G_CALLBACK (terminal_window_action_close_window), },
    { TERMINAL_WINDOW_ACTION_EDIT_MENU,         "<Actions>/TerminalWindow/edit-menu",        NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("_Edit"),                         NULL,                                     NULL,                     NULL, },
    { TERMINAL_WINDOW_ACTION_COPY,              "<Actions>/TerminalWindow/copy",             "<control><shift>c",         XFCE_GTK_MENU_ITEM,       N_ ("_Copy"),                         N_ ("Copy to clipboard"),                 "edit-copy",              G_CALLBACK (terminal_window_action_copy), },
#if VTE_CHECK_VERSION (0, 49, 2)
    { TERMINAL_WINDOW_ACTION_COPY_HTML,         "<Actions>/TerminalWindow/copy-html",        NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("Copy as _HTML"),                 N_ ("Copy to clipboard as HTML"),         "edit-copy",              G_CALLBACK (terminal_window_action_copy_html), },
#endif
    ...
    { TERMINAL_WINDOW_ACTION_PASTE_SELECTION,   "<Actions>/TerminalWindow/paste-selection",  NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("Paste _Selection"),              NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_paste_selection), },
    { TERMINAL_WINDOW_ACTION_SELECT_ALL,        "<Actions>/TerminalWindow/select-all",       "<control><shift>a",         XFCE_GTK_MENU_ITEM,       N_ ("Select _All"),                   NULL,                                     "edit-select-all",        G_CALLBACK (terminal_window_action_select_all), },
    { TERMINAL_WINDOW_ACTION_COPY_INPUT,        "<Actions>/TerminalWindow/copy-input",       NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("Copy _Input To All Tabs..."),    NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_copy_input), },
    { TERMINAL_WINDOW_ACTION_PREFERENCES,       "<Actions>/TerminalWindow/preferences",      NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("Pr_eferences..."),               N_ ("Open the preferences dialog"),       "preferences-system",     G_CALLBACK (terminal_window_action_prefs), },
    { TERMINAL_WINDOW_ACTION_VIEW_MENU,         "<Actions>/TerminalWindow/view-menu",        NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("_View"),                         NULL,                                     NULL,                     NULL, },
    ...
    { TERMINAL_WINDOW_ACTION_TERMINAL_MENU,     "<Actions>/TerminalWindow/terminal-menu",    NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("_Terminal"),                     NULL,                                     NULL,                     NULL, },
    { TERMINAL_WINDOW_ACTION_SET_TITLE,         "<Actions>/TerminalWindow/set-title",        "<control><shift>s",         XFCE_GTK_MENU_ITEM,       N_ ("_Set Title..."),                 NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_set_title), },
    { TERMINAL_WINDOW_ACTION_SET_TITLE_COLOR,   "<Actions>/TerminalWindow/set-title-color",  NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("Set Title Co_lor..."),           NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_set_title_color), },
    { TERMINAL_WINDOW_ACTION_SEARCH,            "<Actions>/TerminalWindow/search",           "<control><shift>f",         XFCE_GTK_MENU_ITEM,       N_ ("_Find..."),                      N_ ("Search terminal contents"),          "edit-find",              G_CALLBACK (terminal_window_action_search), },
    { TERMINAL_WINDOW_ACTION_SEARCH_NEXT,       "<Actions>/TerminalWindow/search-next",      NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("Find Ne_xt"),                    NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_search_next), },
    { TERMINAL_WINDOW_ACTION_SEARCH_PREV,       "<Actions>/TerminalWindow/search-prev",      NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("Find Pre_vious"),                NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_search_prev), },
    { TERMINAL_WINDOW_ACTION_SAVE_CONTENTS,     "<Actions>/TerminalWindow/save-contents",    NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("Sa_ve Contents..."),             NULL,                                     "document-save-as",       G_CALLBACK (terminal_window_action_save_contents), },
    { TERMINAL_WINDOW_ACTION_RESET,             "<Actions>/TerminalWindow/reset",            NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("_Reset"),                        NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_reset), },
    { TERMINAL_WINDOW_ACTION_RESET_AND_CLEAR,   "<Actions>/TerminalWindow/reset-and-clear",  NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("_Clear Scrollback and Reset"),   NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_reset_and_clear), },
    { TERMINAL_WINDOW_ACTION_TABS_MENU,         "<Actions>/TerminalWindow/tabs-menu",        NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("T_abs"),                         NULL,                                     NULL,                     NULL, },
    { TERMINAL_WINDOW_ACTION_PREV_TAB,          "<Actions>/TerminalWindow/prev-tab",         "<control>Page_Up",          XFCE_GTK_MENU_ITEM,       N_ ("_Previous Tab"),                 N_ ("Switch to previous tab"),            "go-previous",            G_CALLBACK (terminal_window_action_prev_tab), },
    { TERMINAL_WINDOW_ACTION_NEXT_TAB,          "<Actions>/TerminalWindow/next-tab",         "<control>Page_Down",        XFCE_GTK_MENU_ITEM,       N_ ("_Next Tab"),                     N_ ("Switch to next tab"),                "go-next",                G_CALLBACK (terminal_window_action_next_tab), },
    { TERMINAL_WINDOW_ACTION_LAST_ACTIVE_TAB,   "<Actions>/TerminalWindow/last-active-tab",  NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("Last _Active Tab"),              N_ ("Switch to last active tab"),         NULL,                     G_CALLBACK (terminal_window_action_last_active_tab), },
    { TERMINAL_WINDOW_ACTION_MOVE_TAB_LEFT,     "<Actions>/TerminalWindow/move-tab-left",    "<control><shift>Page_Up",   XFCE_GTK_MENU_ITEM,       N_ ("Move Tab _Left"),                NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_move_tab_left), },
    { TERMINAL_WINDOW_ACTION_MOVE_TAB_RIGHT,    "<Actions>/TerminalWindow/move-tab-right",   "<control><shift>Page_Down", XFCE_GTK_MENU_ITEM,       N_ ("Move Tab _Right"),               NULL,                                     NULL,                     G_CALLBACK (terminal_window_action_move_tab_right), },
    { TERMINAL_WINDOW_ACTION_HELP_MENU,         "<Actions>/TerminalWindow/help-menu",        NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("_Help"),                         NULL,                                     NULL,                     NULL, },
    { TERMINAL_WINDOW_ACTION_CONTENTS,          "<Actions>/TerminalWindow/contents",         "F1",                        XFCE_GTK_MENU_ITEM,       N_ ("_Contents"),                     N_ ("Display help contents"),             "help-browser",           G_CALLBACK (terminal_window_action_contents), },
    { TERMINAL_WINDOW_ACTION_ABOUT,             "<Actions>/TerminalWindow/about",            NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("_About"),                        NULL,                                     "help-about",             G_CALLBACK (terminal_window_action_about), },
    { TERMINAL_WINDOW_ACTION_ZOOM_MENU,         "<Actions>/TerminalWindow/zoom-menu",        NULL,                        XFCE_GTK_MENU_ITEM,       N_ ("_Zoom"),                         NULL,                                     NULL,                     NULL, },
    { TERMINAL_WINDOW_ACTION_SHOW_MENUBAR,      "<Actions>/TerminalWindow/show-menubar",     NULL,                        XFCE_GTK_CHECK_MENU_ITEM, N_ ("Show _Menubar"),                 N_ ("Show/hide the menubar"),             NULL,                     G_CALLBACK (terminal_window_action_show_menubar), },
    { TERMINAL_WINDOW_ACTION_SHOW_TOOLBAR,      "<Actions>/TerminalWindow/show-toolbar",     NULL,                        XFCE_GTK_CHECK_MENU_ITEM, N_ ("Show _Toolbar"),                 N_ ("Show/hide the toolbar"),             NULL,                     G_CALLBACK (terminal_window_action_show_toolbar), },
    { TERMINAL_WINDOW_ACTION_SHOW_BORDERS,      "<Actions>/TerminalWindow/show-borders",     NULL,                        XFCE_GTK_CHECK_MENU_ITEM, N_ ("Show Window _Borders"),          N_ ("Show/hide the window decorations"),  NULL,                     G_CALLBACK (terminal_window_action_show_borders), },
    ...
    { TERMINAL_WINDOW_ACTION_READ_ONLY,         "<Actions>/TerminalWindow/read-only",        NULL,                        XFCE_GTK_CHECK_MENU_ITEM, N_ ("_Read-Only"),                    N_ ("Toggle read-only mode"),             NULL,                     G_CALLBACK (terminal_window_action_readonly), },
    { TERMINAL_WINDOW_ACTION_SCROLL_ON_OUTPUT,  "<Actions>/TerminalWindow/scroll-on-output", NULL,                        XFCE_GTK_CHECK_MENU_ITEM, N_ ("Scroll on _Output"),             N_ ("Toggle scroll on output"),           NULL,                     G_CALLBACK (terminal_window_action_scroll_on_output), },
  ...
  if (event->keyval == GDK_KEY_Insert || event->keyval == GDK_KEY_KP_Insert)
    {
      if (modifiers == (GDK_CONTROL_MASK | GDK_SHIFT_MASK))
        ...
        {
          terminal_window_action_paste_selection (window);
          return TRUE;
        }
    }
...
static void
terminal_window_action_show_toolbar (TerminalWindow  *window)
{
//  gboolean show;
//
...
static void
terminal_window_action_show_borders (TerminalWindow  *window)
{
//G_GNUC_BEGIN_IGNORE_DEPRECATIONS
                                      ...
                                      GtkWidget           *menu)
{
  ...
  terminal_window_menu_clean (GTK_MENU (menu));
  xfce_gtk_toggle_menu_item_new_from_action_entry (get_action_entry (TERMINAL_WINDOW_ACTION_SHOW_MENUBAR), G_OBJECT (window), TRUE, GTK_MENU_SHELL (menu));
