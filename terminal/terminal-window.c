...
static XfceGtkActionEntry action_entries[] =
{
    ...
    { TERMINAL_WINDOW_ACTION_CLOSE_OTHER_TABS,      "<Actions>/TerminalWindow/close-other-tabs",      "",                          XFCE_GTK_MENU_ITEM,       N_ ("Close Other Ta_bs"),             NULL,                                     "edit-clear",             G_CALLBACK (terminal_window_action_close_other_tabs), },
    ...
    { TERMINAL_WINDOW_ACTION_ZOOM_IN_ALT,           "<Actions>/TerminalWindow/zoom-in-alt",           "<control>KP_Add",           XFCE_GTK_MENU_ITEM,       N_ ("Zoom In Alt"),                   NULL,                                     "zoom-in-alt",            G_CALLBACK (terminal_window_action_zoom_in), },
    ...
    { TERMINAL_WINDOW_ACTION_ZOOM_OUT_ALT,          "<Actions>/TerminalWindow/zoom-out-alt",          "<control>KP_Subtract",      XFCE_GTK_MENU_ITEM,       N_ ("Zoom Out Alt"),                  NULL,                                     "zoom-out-alt",           G_CALLBACK (terminal_window_action_zoom_out), },
    ...
    { TERMINAL_WINDOW_ACTION_ZOOM_RESET_ALT,        "<Actions>/TerminalWindow/zoom-reset-alt",        "<control>KP_0",             XFCE_GTK_MENU_ITEM,       N_ ("_Normal Size Alt"),              NULL,                                     "zoom-original-alt",      G_CALLBACK (terminal_window_action_zoom_reset), },
    ...
    { TERMINAL_WINDOW_ACTION_SAVE_CONTENTS,         "<Actions>/TerminalWindow/save-contents",         "",                          XFCE_GTK_MENU_ITEM,       N_ ("Sa_ve Contents..."),             NULL,                                     "document-save-as",       G_CALLBACK (terminal_window_action_save_contents), },
    ...
    { TERMINAL_WINDOW_ACTION_ABOUT,                 "<Actions>/TerminalWindow/about",                 "",                          XFCE_GTK_MENU_ITEM,       N_ ("_About"),                        NULL,                                     "help-about",             G_CALLBACK (terminal_window_action_about), },
