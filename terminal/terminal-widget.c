...
static gboolean           terminal_widget_action_shift_scroll_page_up   (TerminalWidget   *widget);
static gboolean           terminal_widget_action_shift_scroll_page_down (TerminalWidget   *widget);
...
static XfceGtkActionEntry action_entries[] =
{
  ...
  { TERMINAL_WIDGET_ACTION_SCROLL_PAGE_UP,   "<Actions>/terminal-widget/shift-pageup",   "<Shift>Page_Up",   XFCE_GTK_MENU_ITEM, N_ ("Scroll one Page Up"),   NULL, NULL, G_CALLBACK (terminal_widget_action_shift_scroll_page_up),   },
  { TERMINAL_WIDGET_ACTION_SCROLL_PAGE_DOWN, "<Actions>/terminal-widget/shift-pagedown", "<Shift>Page_Down", XFCE_GTK_MENU_ITEM, N_ ("Scroll one Page Down"), NULL, NULL, G_CALLBACK (terminal_widget_action_shift_scroll_page_down), },
};
...
static gboolean
terminal_widget_action_shift_scroll_page_up (TerminalWidget *widget)
{
...
static gboolean
terminal_widget_action_shift_scroll_page_down (TerminalWidget *widget)
{
  GtkAdjustment *adjustment = gtk_scrollable_get_vadjustment (GTK_SCROLLABLE (widget));
  gdouble        value;
  gdouble        page_size = gtk_adjustment_get_page_size (adjustment);

  value = MIN (gtk_adjustment_get_value (adjustment) + page_size, gtk_adjustment_get_upper (adjustment) - page_size);
